function[AoA, Speed_Attitude] =  Angle_Of_Attack_in_DLR_NRS( V, V_wind, q)
...
% Speed_pitch:    First Euler angle of the Speed Vector Attitude (XYZ) [rad]
% Speed_yaw:      Secod Euler angle of the Speed Vector Attitude (XYZ) [rad]
%
