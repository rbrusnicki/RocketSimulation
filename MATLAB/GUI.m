...
% Last Modified by GUIDE v2.5 30-Jan-2019 09:41:55
...
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
run VS50_dynamics_DLR
set(handles.Output_Line,'String','Done!!')
...
% --- Executes during object creation, after setting all properties.
function Output_Line_CreateFcn(hObject, eventdata, handles)
% hObject    handle to Output_Line (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    empty - handles not created until after all CreateFcns called
...
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
% [lon, latd, alt] = VS50_dynamics_DLR();
n=2000;
...
% --- Otherwise, executes on mouse press in 5 pixel border or over Output_Line.
function Output_Line_ButtonDownFcn(hObject, eventdata, handles)
% hObject    handle to Output_Line (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
